...
1.  You need to download and set up Git for Windows (separate from GitHub) too.  [Here](http://git-scm.com/) is the link for the program.
...
3.	To tell RStudio where Git is click Browse in 'Git executable' and point to C:/Users/YOUR_USERNAME/AppData/Local/GitHub/PortableGit_aBUNCHofRandomCharacters/bin/git.exe (NOTE: In order to see AppData you'll need to make sure the WindowsExplorer settings are set to View Hidden Files and Folders)
